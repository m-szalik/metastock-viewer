...
public class Browser implements ActionListener, WindowListener {
    final JMenu chartsMI = new JMenu("Charts");
    private final JMenuItem open = new JMenuItem("Open...", GUIUtil.getIcon("open.png"));
    private final JMenuItem exit = new JMenuItem("Exit", null);
    private final JMenu recent = new JMenu("Recent");
    private final JMenuItem test = new JMenuItem("Test");
    final JMenuItem chart1 = new JMenuItem("OHLC");
    ...
    private final Set<String> recentFiles;
            ...
            protected List<ErrorRecord> doInBackground() throws Exception {
                ...
                try {
                    ...
                    if (!errorRecords.isEmpty()) {
                        new ErrorReportDialog(jFrame, zipFile, errorRecords);
